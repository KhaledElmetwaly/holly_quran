...
double moshafFontSize = 28;
Uri quranAppurl = Uri.parse('https://github.com/KhaledElmetwaly');
...
Future readBookMark() async {
  log("readBook mark caled");
  final prefs = await SharedPreferences.getInstance();
  try {
    bookMarkedAyah = await prefs.getInt('ayah')!;
    bookMarkedSurah = await prefs.getInt('surah')!;
    return true;
  } catch (e) {
    return false;
  }
...
Future getSetting() async {
  try {
    ...
    arabicFontSize = await prefs.getInt("moshafFontSize")!.toDouble();
  } catch (e) {
    arabicFontSize = 28;
    moshafFontSize = 40;
  }
